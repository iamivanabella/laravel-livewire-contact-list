        ...
        <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
            <div class="max-w-xl">
                <section>
                    ...
                    <form wire:submit.prevent="update" class="mt-6 space-y-6" enctype="multipart/form-data">
                        <div>
                        ...
                        <div>
                            ...
                            @elseif ($existingAvatar)
                                <img src="{{ asset('storage/' . $existingAvatar) }}" class="mt-2" style="max-height: 200px;">
                            @endif
                        </div>
